 ...
 * Red Wolf Theme - Complete Security Scanner with Real Detection
...
║   ╚══╝╚══╝ ╚══════╝╚═════╝     ╚═════╝ ╚══════╝╚═╝╚═╝  ╚═══╝   ╚═╝            ║
║                                                                              ║
║                    Web OSINT Tool v8.0 - Node.js Edition                    ║
...
`;
    ...
    _saveExtractedData() {
        try {
            ...
            let report = `Web OSINT Tool - Complete Data Extraction Report\n`;
            report += `${'='.repeat(70)}\n`;
